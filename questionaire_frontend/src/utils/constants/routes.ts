...
export const ROUTES = <RouteModel[]>[
    ...
    { path: '/admin/new-business-type', root: '/admin/business-types', rootBreadcrumb: 'Business Types', breadcrumb: 'New Business Type' },
    { path: '/admin/edit-business-type/', root: '/admin/business-types', rootBreadcrumb: 'Business Types', breadcrumb: 'Edit Business Type' },
